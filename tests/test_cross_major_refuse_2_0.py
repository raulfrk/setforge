...
exit with the "upgrade setforge" message and NO Python traceback. The engine
is now major 4, so a major-5 config exercises the same guard a 1.x engine
would hit reading a 2.0 config. This pins that the major bump did not regress
the clean-refusal contract.
"""
