"""Docker fixtures for the E2E test ring (tracked_files-nen.9).
...
# tag, which naturally invalidates the build cache — see tracked_files-0ci.
...
def docker_image() -> str:
    ...
    current hash we build. See tracked_files-0ci for the footgun this
    replaces.
